...
import cats.{Bimonad, CommutativeMonad, Defer, Eq, Functor, Group, Monoid, Order, PartialOrder, Reducible, Representable, Semigroup, StackSafeMonad}
 ...
 *
 * The Latter and Always are both lazy strategies while Now is eager.
...
sealed abstract private class EvalInstances extends EvalInstances0 {
...
sealed abstract private class EvalInstances0 extends EvalInstances1 {
...
sealed abstract private class EvalInstances1 {
